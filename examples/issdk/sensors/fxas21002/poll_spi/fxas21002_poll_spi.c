...
int app_main(void)
{
    ...
    status = pSPIdriver->Initialize(SPI_SignalEvent(FXAS21002_SPI_INDEX));
    ...
    status = pSPIdriver->Control(ARM_SPI_MODE_MASTER | ARM_SPI_CPOL0_CPHA0 | ARM_SPI_DATA_BITS(8), FXAS21002_SPI_BAUDRATE);
    if (ARM_DRIVER_OK != status)
    {
    ...
    status = FXAS21002_SPI_Initialize(&fxas21002Driver, &FXAS21002_SPI_DRIVER, FXAS21002_SPI_INDEX, FXAS21002_SPI_CS,
