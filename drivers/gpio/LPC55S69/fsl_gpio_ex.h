 ...
 *
 * @param base      GPIO peripheral base pointer (GPIO)
 ...
 */
static inline void GPIO_PinSetDirection(GPIO_Type *base, uint32_t port, uint32_t pin, gpio_pin_direction_t direction)
{
