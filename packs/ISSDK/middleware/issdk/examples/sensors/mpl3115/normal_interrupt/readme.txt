...
Demo Overview
============
The MPL3115 Normal Interrupt example application demonstrates the use of the MPL3115
sensor in the Normal (Non-Buffered) Mode with Interrupts.
...
The sensor reads samples as per the configured Auto acquisition time step and then
