...
/**
 * @file fxls8974_drv_spi.c
 * @brief The fxls8974_drv_spi.c file implements the FXLS8964/67 sensor driver interfaces.
 */
...
int32_t FXLS8974_SPI_Initialize(
    fxls8974_spi_sensorhandle_t *pSensorHandle, ARM_DRIVER_SPI *pBus, uint8_t index, uint32_t SlaveSelect, uint8_t *whoami)
{
    int32_t status;
    uint8_t reg;
