 ...
 * @brief    Virtual I/O implementation for FRDM-K22F Development Board
 * @version  V1.0.0
 * @date     10. May 2023
 ******************************************************************************/
/*
...
// VIO pins
#define pinLED0         GPIO_PORTA(1U)
#define pinLED1         GPIO_PORTA(2U)
#define pinLED2         GPIO_PORTD(5U)
#define pinBUTTON1      GPIO_PORTB(17U)
#define pinBUTTON2      GPIO_PORTC(1U)
